...
namespace aether
{
    ...
    public:
        ...
        void paint(juce::Graphics& g) override
        {
            ...
            g.drawText("AETHER", (int)textX, (int)(bounds.getCentreY() - 14), 200, 24, juce::Justification::left);
            ...
            g.drawText("L A B S", (int)textX + 2, (int)(bounds.getCentreY() + 8), 200, 15, juce::Justification::left);
